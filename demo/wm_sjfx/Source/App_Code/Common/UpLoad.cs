...
namespace Common
{
    public class UpLoad
    {
        ...
        int thumbnailwidth = 80;//生成缩略图宽度(像素)
        int thumbnailheight = 80;//生成缩略图高度(像素)
        ...
        public string fileSaveAs(HttpPostedFile postedFile, bool isThumbnail, int ThWidth, int ThHeight, bool isWater)
        {
            return fileSaveAs(postedFile, isThumbnail, ThWidth, ThHeight, isWater, false, false);
        }
        ...
        /// <returns>服务器文件路径</returns>
        public string fileSaveAs(HttpPostedFile postedFile, bool isThumbnail, int ThWidth, int ThHeight, bool isWater, bool _isImage)
        {
            return fileSaveAs(postedFile, isThumbnail, ThWidth, ThHeight, isWater, _isImage, false);
        }
        ...
        /// <returns>服务器文件路径</returns>
        public string fileSaveAs(HttpPostedFile postedFile, bool isThumbnail,int ThWidth,int ThHeight, bool isWater, bool _isImage, bool _isReOriginal)
        {
            try
            {
                ...
                //string dirPath = "/upload/book/"; //上传目录相对路径
                ...
                {
                    //Thumbnail.MakeThumbnailImage(toFileFullPath + fileName, toFileFullPath + "small_" + fileName, ThWidth, ThHeight, "Cut");
                    CSA.IO.ImageHelper.ResizeImg(toFileFullPath + fileName, toFileFullPath + "small_" + fileName, ThWidth, ThHeight);
