    ...
    public class Config
    {
        ...
        public static string getSiteConfig(string preTitle, string repKeywords, string repDesc)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                re += "<meta name=\"author\" content=\"网站建设：炎麟科技 - http://www.yanlinsoft.com\" />\r\n";
            }
            return re;
        }
        /// <summary>
            ...
            if (dr != null)
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (!string.IsNullOrEmpty(dr["seoTitle_en"].ToString()))
                        ...
                        re += "<title>" + dr["title_en"] + "|" + drDefault["title_en"].ToString() + "</title>\r\n";
                ...
                re += "<meta name=\"author\" content=\"Website Design by HUNUO - http://www.yanlinsoft.com\" />\r\n";
            }
            else
                return getSiteConfig();
            return re;
