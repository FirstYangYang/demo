        ...
        <div id="divDtls" class="divFoot" runat="server" visible="false">
            ...
            <tr><th>用　　户：</th>
               ...
               <th style="color:Red">设置密码：</th>
                <td ><input class="textBg" title="设置密码" type="text" runat="server" id="Password" style="width:150px"/></td>         
            </tr>
            <tr>
            <th>名　　称：</th>
                <td><input class="textBg" title="名　　称" type="text" runat="server" id="KK_name" style="width:150px"/></td>
            <th>所属部门：</th>
                <td><asp:DropDownList CssClass="dropList" title="所属部门" runat="server" ID="KK_OuID" style="width:150px"></asp:DropDownList></td>
                
            </tr>
            
            <tr><th>联系电话：</th>
                <td><input class="textBg" title="联系电话" type="text" runat="server" id="KK_Phone" style="width:150px"/></td>
                <th>电子邮箱：</th>
