...
<body>
    ...
    <div id="divContent" class="body" runat="server">
        ...
        <div id="divList" runat="server">
            <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="95%" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Code" DataFormatString="{0}" HeaderText="编号" SortExpression="Code" Visible="false">
                    ...
                    <asp:TemplateField HeaderText="下级分类数" Visible="false">
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                        <ItemTemplate>
                            <%# Eval("kindCount") %>
            ...
            <tr>
             ...
             <tr>
                ...
                <td colspan="3">
                    ...
                    <br />
                    <font color="red">图片尺寸：248px*340px</font>
                </td>
            </tr>
             <tr>
                <td class="tdLeft">
