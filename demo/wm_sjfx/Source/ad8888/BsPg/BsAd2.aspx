<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsAd2.aspx.cs" Inherits="admin_BsPg_BsAd2" %>
        ...
        <div id="divList" runat="server">
            <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="100%" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Url" DataFormatString="{0}" HeaderText="链接地址" SortExpression="Title" Visible="false">
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                    </asp:BoundField>
                    ...
                    <asp:TemplateField HeaderText="广告类型">
                        <ItemTemplate>
                            <%# getTypeName() %></ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="图片">
                        <ItemTemplate>
                            <%# getPic(Eval("pic")) %></ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                    </asp:TemplateField>
        ...
        <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <iframe scrolling="no" width="800" height="190" frameborder="0" src="../uploadIframe.aspx?id=KK_Pic&multi=false&isWatermark=false&filelist=<%=this.KK_Pic.Value %>">
                    </iframe><br /><font color=red>高度：260px   宽度建议在1920px以上</font>
                </td>
            </tr>
            <%
                }
