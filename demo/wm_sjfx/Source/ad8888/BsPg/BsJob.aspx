        ...
        <div id="divList" runat="server">
            <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="100%" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="jobAdds" DataFormatString="{0}" HeaderText="工作地点" SortExpression="jobAdds">
                    ...
                    <asp:BoundField DataField="training" DataFormatString="{0}" HeaderText="招聘人数" SortExpression="training">
                        <HeaderStyle HorizontalAlign="Center" Width="80px" BorderWidth="1px" BorderStyle="Solid">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" Width="80px" BorderWidth="1px" BorderStyle="Solid">
                        </ItemStyle>
                    ...
                    <asp:BoundField DataField="addtime" DataFormatString="{0}" HeaderText="发布日期" SortExpression="Title">
                        <HeaderStyle HorizontalAlign="Center" Width="120px" BorderWidth="1px" BorderStyle="Solid">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" Width="120px" BorderWidth="1px" BorderStyle="Solid">
                        </ItemStyle>
    ...
    <div id="divDtls" class="divFoot" runat="server" visible="false">
        ...
        <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
            ...
            <tr>
                ...
                <td>
                    <input title="工作地点" class="textBg" type="text" runat="server" id="KK_jobAdds" style="width: 200px" />
                </td>
            </tr>
            <tr>
                <td class="tdLeft">
                ...
                <td>
                    <input title="招聘人数" class="textBg" type="text" runat="server" id="KK_training" style="width: 200px" />
                </td>
                <td class="tdLeft">
                    工资待遇：
                </td>
                <td>
                    <input title="工资待遇" class="textBg" type="text" runat="server" id="KK_treatment" style="width: 200px" />
                </td>
            </tr>
            <tr>
                <td class="tdLeft">
                ...
                <td>
                    <input title="有效时间" class="textBg" type="text" runat="server" id="KK_date" style="width: 200px" />
                </td>
            </tr>
