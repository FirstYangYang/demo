<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsNewsKind2.aspx.cs" Inherits="admin_BsPg_BsNewsKind2" %>
            ...
            <div id="divDtls" class="divFoot body" runat="server" visible="false">
                ...
                <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                    ...
                    <tr>
                        ...
                        <td >
                            <input class="textBg" title="名称" type="text" runat="server" lock="1" id="KK_Name" style="width: 350px" />
                        </td>
                    </tr>
                    <tr style="<%=hasnotes %>">
                        <td class="tdLeft">备注：
                    ...
                    <tr style="<%=hassize %>">
                        ...
                        <td colspan="3">
                            ...
                            <font color="red">270px*168px.</font>
                        </td>
                    </tr>
