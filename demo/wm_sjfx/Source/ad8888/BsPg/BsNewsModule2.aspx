<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsNewsModule2.aspx.cs" Inherits="admin_BsPg_BsNewsModule2" %>
...
<body>
    ...
    <script type="text/javascript" language="javascript">
        ...
        var defaultUrl = '<%=getLinkWidthBaseParas("BsNewsListNews.aspx",new string[]{"pcode="+pcode,"type="+ptype})%>';
