<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsNewsListNews.aspx.cs" Inherits="admin_BsNewsListNews" %>
...
<body>
    ...
    <div id="divContent" class="body" runat="server">
        ...
        <div id="divList" runat="server">
            <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="98%" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="SortNo" DataFormatString="{0}" HeaderText="排序号" SortExpression="SortNo">
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" Width="56px">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" Width="56px">
                        </ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="AddUserName" DataFormatString="{0}" HeaderText="添加者" SortExpression="AddUserName">
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" Width="50px" BorderStyle="Solid">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" Width="50px" BorderStyle="Solid">
                        </ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="AddTime" DataFormatString="{0}" HeaderText="添加时间" SortExpression="addTime">
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" Width="120" BorderStyle="Solid">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" Width="120" BorderStyle="Solid">
                        </ItemStyle>
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="modTime" DataFormatString="{0}" HeaderText="修改时间" SortExpression="modTime">
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" Width="120" BorderStyle="Solid">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" Width="120" BorderStyle="Solid">
                        </ItemStyle>
    ...
    <div id="divDtls" class="divFoot body" runat="server" visible="false">
         <div class="tab">
                <ul>
                    <li class="current"><a href="javascript:" onfocus="blur()">详细内容</a></li>
                    <%if(multiLanguageEN){ %>
                    <li><a href="javascript:" onfocus="blur()">详细内容_英文</a></li>
                    <%} %>
                </ul>
            </div>
        <div class="wrapBox ">
                ...
                <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                    ...
                    <tr>
                        <td class="tdLeft" width="100">
                            <div style=" width:100px;">文章分类：</div>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input title="标题" class="textBg" type="text" runat="server" id="KK_Title" style="width: 600px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLeft">
                        ...
                        <td colspan="3">
                            <input style="width: 500px" id="KK_addtime" runat="server" onclick="WdatePicker({alwaysUseStartDate:true,isShowClear:false,readOnly:true})"
                                value="请选择日期" />
                        </td>
                    ...
                    <tr style="<%=hascontent%>">
                        <td class="tdLeft">
                         ...
                         <td>
                            <textarea title="内容" runat="server" id="KK_Content" style=" width:1000px; height:300px;"></textarea>
                        </td>
                    </tr>
                    <tr style="<%=hasnotes %>">
                        <td class="tdLeft">
                        ...
                        <td>
                            <textarea class="textCSS" title="简介" runat="server" style="width: 600px; height: 100px"
                    ...
                    <tr style="<%=hasurl%>">
                        ...
                        <td>
                            <input title="视频外链" class="textBg" type="text" runat="server" id="KK_url" style="width: 300px" /><br />
                            <font color="gray">默认使用视频外链，如视频外链为空，则使用本地视频</font>
                        </td>
                    </tr>
                    <tr style="<%=hasmedia%>">
                        <td class="tdLeft">
                        ...
                        <td>
                            <input type="text" title="本地视频" id="KK_Media" runat="server" style="display: none" />
                            <iframe scrolling="no" width="600" height="190" frameborder="0" src="../uploadIframe.aspx?id=KK_Media&multi=false&filelist=<%=this.KK_Media.Value %>">
                            </iframe>
                        </td>
                    </tr>
                    <tr style="<%=hasimg %>">
                        ...
                        <td>
                            ...
                            <iframe scrolling="auto" width="600" height="250" frameborder="0" src="../uploadIframe.aspx?id=KK_Pic&multi=true&filelist=<%=this.KK_Pic.Value %>">
                            </iframe>
                            <br /><font color="red">图片最佳尺寸：350px * 222px</font>
                        </td>
                    </tr>
                    <tr style="<%=hasurl%>">
                        <td class="tdLeft">
                        ...
                        <td>
                            <input type="text" title="视频缩略图" id="KK_Pic_small" runat="server" style="display: none" />
                            <iframe scrolling="auto" width="600" height="250" frameborder="0" src="../uploadIframe.aspx?id=KK_Pic_small&multi=true&filelist=<%=this.KK_Pic_small.Value %>">
                            </iframe>
                            <br />
                            <font color="gray">只用于促销活动填写</font>
                        </td>
                    </tr>
            ...
            <div class="body">
                <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                    ...
                    <tr style="<%=hasnotes %>">
                        ...
                        <td>
                            <textarea class="textCSS" title="简介" runat="server" style="width: 800px; height: 100px"
        ...
        <tr>
                ...
                <td >
                    <asp:Button ID="btnSvAdd" runat="server" CssClass="SrvButton btnClass" Text="保存新增" Visible="true"
                        OnClick="btnSvAdd_Click" OnClientClick="return checkForm()" />&nbsp;
                    <asp:Button ID="btnSvEdit" runat="server" CssClass="SrvButton btnClass" Text="保存修改" Visible="true"
                        OnClick="btnSvEdit_Click" />&nbsp;
                    <asp:Button ID="btnSvCancel" runat="server" CssClass="SrvButton btnClass" Text="取　　消" OnClick="btnSvCancel_Click" />
                </td>
            </tr>
              </table>
    </div>
