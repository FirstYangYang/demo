                ...
                <label id="lblTitle" style="color: #15428B; padding-right: 0px; padding-left: 10px">
                    查询条件：</label></span> <span>
                        ...
                        <asp:DropDownList CssClass="dropList" Search_Compare="like_code" Search_Field="a.isindex"
                            runat="server" ID="Search_Keyword2" Visible="false">
                 ...
                 <asp:LinkButton ID="btnExport" OnClick="btnExport_Click" Visible="false" CssClass="dot_Item" runat="server"><span class="Icon_item icon_export"></span><i>导出Excel</i></asp:LinkButton>
                   ...
                   <%--<asp:LinkButton ID="btnShow" SetField="isPromote" SetValue="1" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listshow"></span><i>设为推荐</i></asp:LinkButton>
                 <asp:LinkButton ID="btnNoHide" SetField="isPromote" SetValue="0" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listhide"></span><i>取消推荐</i></asp:LinkButton>
            ...
            <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="98%" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="查看">
                        <ItemTemplate>
                            <a href='<%# getLinkWidthBaseParas("BsProItem.aspx","pkid",Eval("pkid").ToString()) %>'
                                target="_blank">查看</a>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="隐藏" Visible="false">
                        <ItemTemplate>
                     ...
                     <asp:TemplateField HeaderText="推荐" Visible="false">
                        <ItemTemplate>
                            <%# Eval("isPromote").ToString() == "0" ? "否" : "<font color=red>是</font>"%>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="图片" SortExpression="pic">
                        <ItemTemplate>
                            <img src='<%# CSA.HC.Common.getAppPath()+Eval("pic").ToString().Split(',')[0] %>'
