    ...
    <form id="frmList" runat="server">
        ...
        <div id="divDtls" class="divFoot" runat="server" visible="false">
         ...
         <colgroup>
            ...
            <tr><td class="tdLeft">
                链接名：</td>
                <td colspan="3"><input title="链接名" class="textBg" type="text" runat="server" id="KK_Name" style="width:350px"/></td>
            </tr>         
             <tr><td class="tdLeft">
                链接地址：</td>
                <td colspan="3"><input title="链接地址" class="textBg" type="text" runat="server" id="KK_Url" style="width:350px"/></td>
            </tr>
            <tr><td class="tdLeft">排序号：</td>
                <td colspan="3"><input class="textBg" title="排序号" type="text" runat="server" id="KK_SortNo" style="width:50px"/>
            ...
            <tr>
                ...
                <iframe scrolling="no" width="800" height="190" frameborder=0
                 src="../uploadIframe.aspx?id=KK_Logo&multi=false&filelist=<%=this.KK_Logo.Value %>"></iframe><br />

                 <font color=red>尺寸：115px*40px</font>
