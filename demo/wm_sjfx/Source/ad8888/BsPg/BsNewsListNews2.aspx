<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsNewsListNews2.aspx.cs" Inherits="admin_BsNewsListNews2" %>
                ...
                <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                    ...
                    <tr style="<%=hasimg %>">
                        ...
                        <td>
                            ...
                            <iframe scrolling="auto" width="600" height="250" frameborder="0" src="../uploadIframe.aspx?id=KK_Pic&multi=true&filelist=<%=this.KK_Pic.Value %>&pathlist=upload|0|0,upload/Small|310|108">
                            </iframe>
                            <br /><font color="red">图片最佳尺寸：<%=imagesize%></font>
                        </td>
                    </tr>
                    <tr style="<%=hasurl%>">
                        <td class="tdLeft">
