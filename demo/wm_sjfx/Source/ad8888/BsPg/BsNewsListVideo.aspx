<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsNewsListVideo.aspx.cs" Inherits="admin_BsPg_BsNewsListVideo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        KindEditor.ready(function (K) {
            window.editor = K.create('#KK_Content', { width: '100%', height: '400px' });
            window.editor = K.create('#KK_Content_en', { width: '100%', height: '400px' });
        });
    </script>
    <script type="text/javascript">
        $(function () {
        ...
        <div id="divList" runat="server">
            <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="98%" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="显示/隐藏" Visible="false">
                        <ItemTemplate>
                    ...
                    <asp:BoundField DataField="AddTime" DataFormatString="{0}" HeaderText="添加时间" SortExpression="addTime" Visible="false">
                    ...
                    <asp:BoundField DataField="modTime" DataFormatString="{0}" HeaderText="修改时间" SortExpression="modTime" Visible="false">
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" Width="120" BorderStyle="Solid">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" Width="120" BorderStyle="Solid">
                        </ItemStyle>
                ...
                <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                    ...
                    <tr style="<%=hasurl%>">
                        ...
                        <td>
                            ...
                            <font color="gray">默认优先使用优酷视频外链，如外链为空，则使用本地上传视频</font>
                        </td>
                    </tr>
                    <tr style="<%=hascontent%>">
                        <td class="tdLeft">
                            文章内容：</td>
                        <td>
                            <textarea title="内容" runat="server" id="KK_Content" style="width: 800px; height: 300px"></textarea>
                        </td>
                    </tr>
                    <tr style="<%=hasmedia%>">
                        <td class="tdLeft">
                        ...
                        <td>
                            ...
                            <iframe scrolling="no" width="800" height="190" frameborder="0" src="../uploadIframe.aspx?id=KK_Media&multi=false&filelist=<%=this.KK_Media.Value %>">
                            </iframe><br />
                            <font color="gray">本地在线上传，基于网页限制，上传视频大小不超过10M，超过10M，请使用FTP上传【格式：FLV】</font>
                        </td>
                    </tr>
                    <tr style="<%=hasimg %>">
                        <td class="tdLeft">
                        ...
                        <td>
                            ...
                            <%} %>
                            <font color="gray">没有缩略图请留空！尺寸不建议大于1200px*1200px</font>
                    ...
                    <tr style="<%=hasurl%>">
                        ...
                        <td>
                            ...
                            <br />
                            <font color="gray">缩略图尺寸：230px*155px</font>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLeft">
