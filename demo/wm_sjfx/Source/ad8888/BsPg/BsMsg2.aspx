<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsMsg2.aspx.cs" Inherits="bspg_BsMsg2" %>
<!--数据操作的页面模板-->
    ...
    <form id="frmList" runat="server">
          ...
          <div id="divHead" class="divHead" runat=server>
            ...
            <div style="float:left; width:auto; border:0px red solid;">
                 ...
                 <asp:LinkButton ID="btnExport" OnClick="btnExport_Click" Visible="false" CssClass="dot_Item" runat="server"><span class="Icon_item icon_export"></span><i>导出Excel</i></asp:LinkButton>
                  ...
                  <asp:LinkButton ID="btnShow" SetField="status" SetValue="0" Visible="false" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listshow"></span><i>设为显示</i></asp:LinkButton>
                 <asp:LinkButton ID="btnNoHide" SetField="status" SetValue="1" Visible="false" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listhide"></span><i>设为隐藏</i></asp:LinkButton>
        ...
        <!--Content-->
            ...
            <div id="divList" runat="server">
             ...
             <asp:CommandField HeaderText="查看" SelectText="查看" ShowSelectButton="True">
                ...
                <ItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="状态" SortExpression="status" Visible="false">
                <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="未/已回复" SortExpression="isReply" Visible="false">
                    <ItemTemplate>
            ...
            <asp:BoundField DataField="name" DataFormatString="{0}" HeaderText="联系人" SortExpression="name">
                ...
                <asp:BoundField DataField="title" DataFormatString="{0}" HeaderText="应聘职位" SortExpression="title">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
                 
                   <asp:BoundField DataField="mobile" DataFormatString="{0}" HeaderText="联系方式" SortExpression="mobile">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
              ...
              <asp:BoundField DataField="email" DataFormatString="{0}" HeaderText="邮箱" SortExpression="email" Visible="false">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
                <asp:TemplateField HeaderText="简历">
                    <ItemTemplate>
                       <a href="../../upload/File/<%#Eval("Way").ToString() %>" target="_blank" style=" color:Red;">简历下载</a>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"  BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:TemplateField>
        ...
        <div id="divDtls" class="divFoot" runat="server" visible="false">
           ...
           <tr><td class="tdLeft">姓名：</td>
                <td colspan="3"><input title="姓名" class="textBg" type="text" runat="server" id="KK_name" Lock=1 style="width:200px"/></td>
              <%--<td class="tdLeft">电子邮件：</td>
                <td ><input title="电子邮件" class="textBg" type="text" runat="server" id="KK_email" Lock=1 style="width:200px"/></td>--%>
            </tr>
            <tr><td class="tdLeft">联系电话：</td>
                <td ><input title="联系电话" class="textBg" type="text" runat="server" id="KK_mobile" Lock=1 style="width:200px"/></td>
                <td class="tdLeft">IP：</td>
                <td ><input title="IP" class="textBg" type="text" runat="server" id="KK_IP" Lock=1 style="width:293px"/></td>
            </tr>
            <tr><td class="tdLeft">应聘职位：</td>
                <td colspan=3><input title="应聘职位" class="textBg" type="text" runat="server" id="KK_title" Lock=1 style="width:400px"/></td>
           
            </tr>
            <tr><td class="tdLeft">应聘简述：</td>
                <td colspan=3><textarea title="应聘简述" runat="server" id="KK_content" Lock=1 style="width:500px; height: 143px;"></textarea>
                </td>
                
            </tr>
            <td class="tdLeft">简历：</td>
                <td colspan="3">
                <a href="../../upload/File/<%=drs["Way"] %>" target="_blank" style=" color:Red">简历下载</a>
                </td>
            </tr>
            <tr><td class="tdLeft">
                备注：</td>
