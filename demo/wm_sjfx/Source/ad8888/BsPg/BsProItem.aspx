...
<body>
    ...
    <div id="divDtls" class="divFoot body" runat="server">
        ...
        <tr>
                ...
                <td>
                    <input class="textBg" title="价格" type="text" runat="server" id="KK_Price" style="width: 150px" />
                </td>
            </tr>
            <tr>
                <td class="tdLeft">
                ...
                <td>
                    <input class="textBg" title="价格" type="text" runat="server" id="KK_Sale" style="width: 150px" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td >
                    ...
                    <iframe scrolling="no" width="800" height="350px" scrolling="auto" frameborder="0"
                        src="../uploadIframe.aspx?id=KK_Pic&filelist=<%=this.KK_Pic.Value %>&multi=false&isWatermark=true&pathlist=upload/product|0|0,upload/product/small|270|270">
                    </iframe>
                    <br />图片最小尺寸：270px*270px
                </td>
            </tr>
