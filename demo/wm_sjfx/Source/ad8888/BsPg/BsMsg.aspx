    ...
    <form id="frmList" runat="server">
        ...
        <div id="divDtls" class="divFoot" runat="server" visible="false">
           ...
           <tr><td class="tdLeft">姓名：</td>
                <td ><input title="姓名" class="textBg" type="text" runat="server" id="KK_name" Lock=1 style="width:200px"/></td>
            ...
            <tr><td class="tdLeft">联系电话：</td>
                <td ><input title="联系电话" class="textBg" type="text" runat="server" id="KK_phone" Lock=1 style="width:200px"/></td>
                <td class="tdLeft">IP：</td>
                <td ><input title="IP" class="textBg" type="text" runat="server" id="KK_IP" Lock=1 style="width:293px"/></td>
            </tr>
            <tr><td class="tdLeft">公司名称：</td>
                <td colspan=3><input title="公司名称" class="textBg" type="text" runat="server" id="KK_Company" Lock=1 style="width:400px"/></td>
           
            </tr>
            <tr><td class="tdLeft">留言内容：</td>
                <td colspan=3><textarea title="留言内容" runat="server" id="KK_content" Lock=1 style="width:500px; height: 143px;"></textarea>
                </td>
