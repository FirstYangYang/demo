<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsNewsListContact.aspx.cs" Inherits="admin_BsPg_BsNewsListContact" %>
                ...
                <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                    ...
                    <tr>
                        <td class="tdLeft">
                            公司名称：</td>
                        <td>
                            <input title="公司名称" class="textBg" type="text" runat="server" id="KK_Title" style="width:600px" />
                        </td>
                    </tr>
                    <tr style="<%=hasurl%>">
                        <td class="tdLeft">
                    ...
                    <tr>
                        <td class="tdLeft">
                            公司总机：</td>
                        <td>
                            <input title="公司总机" class="textBg" type="text" runat="server" id="KK_Ca_1" style="width:600px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLeft">
                            业务咨询：</td>
                        <td>
                            <input title="业务咨询" class="textBg" type="text" runat="server" id="KK_Ca_2" style="width:600px" /><br />
                            <input title="业务咨询" class="textBg" type="text" runat="server" id="KK_Ca_2_1" style="width:600px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLeft">
                            传真：</td>
                        <td>
                            <input title="传真" class="textBg" type="text" runat="server" id="KK_Ca_3" style="width:600px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLeft">
                            邮箱：</td>
                        <td>
                            <input title="邮箱" class="textBg" type="text" runat="server" id="KK_Ca_4" style="width:600px" /><br />
                            <input title="邮箱" class="textBg" type="text" runat="server" id="KK_Ca_4_1" style="width:600px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLeft">
                            地址：</td>
                        <td>
                            <input title="地址" class="textBg" type="text" runat="server" id="KK_Ca_5" style="width:600px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLeft">
                            QQ：</td>
                        <td>
                            <input title="QQ" class="textBg" type="text" runat="server" id="KK_Ca_6" style="width:600px" /><br />
                            <input title="QQ" class="textBg" type="text" runat="server" id="KK_Ca_6_1" style="width:600px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLeft">
                        ...
                        <td>
                            <textarea class="textCSS" title="百度插件" runat="server" style="width: 800px; height: 100px" id="KK_Notes"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLeft">
