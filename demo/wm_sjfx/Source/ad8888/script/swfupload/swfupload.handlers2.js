...
*	初始化SWFUpload上传控件
* ****************************************** */
function InitSWFUpload(upurl, uppath, upsize, flashurl,type,iswater, isthumbnail) {
...
function addImage(bigSrc, smallSrc) {
    ...
    //var hidRemark = $('').appendTo(newLi);
    var newImg = $('<div onclick="focus_img(this);" class=\"img_box ' + claname + '">' +
        '<img src="' + smallSrc + '" bigsrc="' + bigSrc + '" /></div>').appendTo(newLi);
    //var newImg = $('<div onclick="focus_img(this);" class=\"img_box ' + claname + '">' +
    //    '<img src="' + smallSrc + '" bigsrc="' + bigSrc + '" />' +
    //    '<span class="remark"><i>暂无描述...</i></span></div>').appendTo(newLi);
    var forea = $('<p class=\"lsp2 ts\"><a href="javascript:;" onclick="show_remark(this);" style=\"vertical-align:top;\" onfocus=\"blur()\">描述</a><textarea name="hide_photo_remark"></textarea></p>').appendTo(newLi);
    var downa = $('<p class=\"lsp\"><a href="javascript:;" onclick="del_img(this);" style=\"color:red\" onfocus=\"blur()\">删除</a></p>').appendTo(newLi);
...
function del_img(obj) {
    ...
    var smallimg = $(obj).parent().prevAll(".img_box").children("img").eq(0).attr("src");
...
function show_remark(obj) {
    //取得隐藏值
    var hidRemark = $(obj).nextAll("textarea[name='hide_photo_remark']").eq(0);
    var m = $.ligerDialog.open({
        ...
        { text: '批量描述', onclick: function () {
            ...
            $("textarea[name='hide_photo_remark']").val(remark);
