...
function addImage(bigSrc, smallSrc) {
    ...
    var forea = $('<p class=\"lsp2 ts\" style="display:none"><a href="javascript:;" onclick="show_remark(this);" style=\"vertical-align:top;\" onfocus=\"blur()\">排序</a><textarea name="hide_photo_remark"></textarea></p>').appendTo(newLi);
