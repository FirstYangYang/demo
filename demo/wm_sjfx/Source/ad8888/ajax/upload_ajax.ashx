...
public class upload_ajax : IHttpHandler, IRequiresSessionState
{
    ...
    private void SingleFile(HttpContext context)
    {
        ...
        string msg = upFiles.fileSaveAs(_upfile, _isthumbnail,ThWidth,ThHeight, _iswater, _isimage);
        //删除已存在的旧文件
    ...
    private void MultipleFile(HttpContext context)
    {
        ...
        UpLoad upFiles = new UpLoad();
        string msg = upFiles.fileSaveAs(_upfile, _isthumbnail,ThWidth,ThHeight, _iswater);
        //返回成功信息
        context.Response.Write(msg);
        context.Response.End();
    }
    ...
    private void AttachFile(HttpContext context)
    {
        ...
        UpLoad upFiles = new UpLoad();
        string msg = upFiles.fileSaveAs(_upfile, _isthumbnail, ThWidth, ThHeight, _iswater, false, true);
        //返回成功信息
        context.Response.Write(msg);
        context.Response.End();
    }
    ...
    private void EditorFile(HttpContext context)
    {
        ...
        UpLoad upFiles = new UpLoad();
        string remsg = upFiles.fileSaveAs(imgFile, true, ThWidth, ThHeight, _iswater);
