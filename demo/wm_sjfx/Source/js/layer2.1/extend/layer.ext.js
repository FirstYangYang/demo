...
! function () {
    ...
    layer.prompt = function (a, c) {
        ...
        var d, e = 2 == a.formType ? '<textarea class="layui-layer-input">' + (a.value || "") + "</textarea>" : function () {
            return '<input type="' + (1 == a.formType ? "password" : "text") + '"  style="float:left;width:150px;" class="layui-layer-input" value="' + (a.value || "") + '">&nbsp;&nbsp;<img class="YZCode"  onclick="this.src =\'/tools/verify_code.ashx?t=\' + Math.random()" src="/tools/verify_code.ashx" alt="" style="padding-left:5px;width:76px;height:30px;cursor:pointer;" />'
        }();
...
function android_click_back() {
    if ($(".layui-layer-iframe").length > 0) {
        layer.closeAll();
        window.androidJs.android_click_back("false");
        return "false";
    }
    else {
        window.androidJs.android_click_back("true");
        return "true";
    }
}